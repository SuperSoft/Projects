//------------------------------------------------------------------------------
//
// Copyright (c) 2011-2012 XIAMEN PANPORT TECHNOLOGY CO.,LTD All rights reserved.
using System;
...
namespace XMCares.BMS.FDI.DAL
{
    ...
    public sealed class OracleDbTypeHelper
    {
        /// <summary>
        /// 读取OracleDbType
        /// </summary>
        ...
        public static OracleDbType GetOracleDbType(Type maiidDbtype, string field)
        {
            var pi = maiidDbtype.GetProperty(field);
            if (pi == null) return OracleDbType.Varchar2;
